...
class AmdSpider(BaseSpider):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.results_per_page = int(kwargs.get('results_per_page', 12))  # Results per API call
    ...
    def make_api_request(self, first_result=0):
        ...
        json_data = {
            ...
            'fieldsToInclude': [
                ...
                'permanentid', 'date', 'filetype', 'parents', 'amd_result_type',
                'amd_release_date', 'amd_lang', 'amd_result_image', 'description',
                'amd_partner', 'amd_cta_link', 'amd_category', 'amd_product_category',
                'amd_region', 'amd_product_brand', 'amd_product_type', 'amd_industries'
            ],
            'q': '',
    ...
    def parse_api_response(self, response):
        ...
        self.logger.info(f"Processing {len(results)} results from offset {first_result}")
        ...
        if (next_first_result < total_count and 
            next_first_result < self.max_results):
